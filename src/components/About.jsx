const About = () => {
  return (
    <div className="bg-gray-100 py-12 px-6 text-center flex flex-col justify-center items-center min-h-[calc(100vh-8rem)]">
      <h1 className="text-4xl font-bold text-[#00274c] mb-6 underline">About Joe Joe's</h1>
