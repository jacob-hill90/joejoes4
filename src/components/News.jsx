...
export default function News() {
  ...
  description={
    <>
      Anticipation is ramping up. Over the weekend, JoeJoe joined Kristin Falconer, founder and owner of{" "}
      <a
      ...
      >
        Trailer Events
      </a>, as a guest on <em>JR Sunday with Mark Hollis</em>. They discussed upcoming plans and shared behind-the-scenes insights.
          <div className="my-4">
